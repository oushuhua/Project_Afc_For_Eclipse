...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	/**
	 * Default AccountMgr.Constructor
	 * 
	 * @param context
	 */
	 ...
	 * @return The width of the view, honoring AccountMgr.Constraints from measureSpec
	 */
	 ...
	 * @param measureSpec
	 *            A measureSpec packed into an int
	 * @return The height of the view, honoring AccountMgr.Constraints from measureSpec
	 */
